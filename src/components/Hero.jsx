        ...
        <>
            ...
            <ul className="rules-list">
                <div className="rule-item">
                    <p><b>Rest</b></p>
                    <p>Ensure that you are taking rest days were necessary</p>
                </div>
                <div className="rule-item">
                    <p><b>Reps</b></p>
            ...
            <p>Complete all of the workouts below and track you progress along the way. All the best with your workouts!</p>
        </>
    )
}